            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="{{ url('/blog') }}" class="navbar-brand">@lang('blog.blog')</a></li>
                        @if (Auth::guest())
                            <li><a href="{{ route('login') }}">@lang('blog.login')</a></li>
                            <li><a href="{{ route('register') }}">@lang('blog.register')</a></li>
                        @else
                            <li class="dropdown">
